    ...
    return (
        <div id="canvasShowPage">
            ...
            <section id="canvasShowPageHead">
                ...
                <div id="csphMiddle">
                    <div id="cspNameCont">{canvasToShow?.name}</div>
                </div>
                <div id="csphRight">
                    <button id="optionBtn" ref={optionBoxBtn} className={`btns ${optionBox ? 'active' : ''}`} onClick={() => setOptionBox(!optionBox)}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
                    ...
                    <CSSTransition in={optionBox} timeout={500} classNames="slideDown" unmountOnExit>
                        <div id="spOptionBox">
                            {isOwner &&
                                <>
                                    <button className="spOptionBtns" onClick={() => props.updateCanvasData('like', canvasToShow)}>
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
                                    ...
                                    <button className="spOptionBtns" onClick={() => props.updateCanvasData('pin', canvasToShow)}>
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
                                    ...
                                    <button className="spOptionBtns" onClick={() => props.updateCanvasData('download', canvasToShow)}>
                                    ...
                                    <button className="spOptionBtns" onClick={() => props.updateCanvasData('archive', canvasToShow)}>
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
                                    ...
                                    <button className="spOptionBtns" onClick={() => props.updateWarning({ show: true, msg: `Are you sure you want to delete '${canvasToShow.name}'?`, greenMsg: 'Cancel', redMsg: 'Delete', func: () => props.updateCanvasData('delete', canvasToShow, () => navigate('/home')) })}>
                            ...
                            <button className="spOptionBtns" onClick={(downloadImage)}>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 512 512">
                                    <path d="M272 16c0-8.8-7.2-16-16-16s-16 7.2-16 16V329.4L139.3 228.7c-6.2-6.2-16.4-6.2-22.6 0s-6.2 16.4 0 22.6l128 128c6.2 6.2 16.4 6.2 22.6 0l128-128c6.2-6.2 6.2-16.4 0-22.6s-16.4-6.2-22.6 0L272 329.4V16zM140.1 320H64c-35.3 0-64 28.7-64 64v64c0 35.3 28.7 64 64 64H448c35.3 0 64-28.7 64-64V384c0-35.3-28.7-64-64-64H371.9l-32 32H448c17.7 0 32 14.3 32 32v64c0 17.7-14.3 32-32 32H64c-17.7 0-32-14.3-32-32V384c0-17.7 14.3-32 32-32H172.1l-32-32zM432 416a24 24 0 1 0 -48 0 24 24 0 1 0 48 0z"></path>
                                </svg>
                                Download Image
            ...
            <section id="canvasShowPageBody" style={{ backgroundImage: `url(${canvasToShow?.content})` }}></section>
        </div >
    )
}
