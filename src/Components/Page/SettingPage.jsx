...
export default function SettingPage(props) {
    ...
    useEffect(() => {
        if (settingPage) {
            ...
            else if (settingPage === 'about') setSettingHeading('about Notekeeper');
    ...
    return (
        <main id="container">
            ...
            <section id="settingPageLeft" className={settingPage ? 'hide' : ''}>
                ...
                <ul id="stnpLBody">
                    <li className={`stnpNavTiles ${settingPage === 'personalize' ? 'active' : ''}`}>
                    ...
                    <li className={`stnpNavTiles ${settingPage === 'background' ? 'active' : ''}`}>
                    ...
                    <li className={`stnpNavTiles ${settingPage === 'theme' ? 'active' : ''}`}>
                    ...
                    <li className={`stnpNavTiles ${settingPage === 'account' ? 'active' : ''}`}>
                    ...
                    {props.user.authProvider !== "guest" &&
                        <>
                            <li className={`stnpNavTiles ${settingPage === 'feedback' ? 'active' : ''}`}>
                            ...
                            <li className={`stnpNavTiles ${settingPage === 'report' ? 'active' : ''}`}>
                    ...
                    <li className={`stnpNavTiles ${settingPage === 'about' ? 'active' : ''}`}>
            ...
            <section id="settingPageRight" className={!settingPage ? 'hide' : ''}>
                {
                    !settingPage ?
                        <div id="settingNothingToShowHere">
                        ...
                        <>
                            <div id="stnpRHead">
                                ...
                                <span id="stnpRHLeft">
                                    <button className="btns" onClick={() => navigate('/setting')}>
                                ...
                                <h2 id="stnpRHMiddle">{settingHeading}</h2>

                                <span id="stnpRHLeft"></span>
                            </div>

                            <section id="stnpRBody">
                                {
                                    <Routes>
