...
export default function CreateTaskPage(props) {
    ...
    return (
        <>
            ...
            <div id='taskPage' className={`${isBackground ? 'bgImgBackdropFilter' : ""}`} style={isBackground ? { background: `url(${backgroundImg}) center center/cover` } : null}>

                <section id="taskPage_head">
                    <div id="taskPage_hLeft">
                    ...
                    <div id="taskPage_hMiddle">
                        <input type="text" value={taskName} className='input' autoComplete='off' placeholder='Eg: Movies to watch' onChange={(e) => setTaskName(e.target.value)} />
                    </div>
                    <div id="taskPage_hRight">
                        {taskList.length && taskName.trim().length ?
                            <button className="btns" onClick={handleSaveTask}>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
                                    <path d="M13.854 3.646a.5.5 0 0 1 0 .708l-7 7a.5.5 0 0 1-.708 0l-3.5-3.5a.5.5 0 1 1 .708-.708L6.5 10.293l6.646-6.647a.5.5 0 0 1 .708 0z" />
                                </svg>
                            </button>
                            :
                            <button className='btns disable'>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
                                    <path d="M13.854 3.646a.5.5 0 0 1 0 .708l-7 7a.5.5 0 0 1-.708 0l-3.5-3.5a.5.5 0 1 1 .708-.708L6.5 10.293l6.646-6.647a.5.5 0 0 1 .708 0z" />
                                </svg>
                            </button>
                ...
                <section id="taskPage_body">

                    <div id="taskPage_bodyPinned">
                    ...
                    <div id="taskPage_bodyDefault">

                        {taskList.filter((el) => el.completed === false).length === 0 &&
                            <div id='taskPage_bodyDefault_nothingToShow'>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
                ...
                <section id="taskPage_foot">
                    <input type="text" value={taskContent} id="taskPage_taskInput" autoFocus autoComplete='off' placeholder='Add a task...' onChange={(e) => setTaskContent(e.target.value)} onKeyUp={(e) => e.key === 'Enter' && addTask()} />
                    <button className="btns" onClick={addTask}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
                            <path fillRule="evenodd" d="M8 2a.5.5 0 0 1 .5.5v5h5a.5.5 0 0 1 0 1h-5v5a.5.5 0 0 1-1 0v-5h-5a.5.5 0 0 1 0-1h5v-5A.5.5 0 0 1 8 2Z" />
                        </svg>
                    </button>
