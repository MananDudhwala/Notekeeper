...
export default function SearchPage(props) {
    ...
    const FolderIcon = () => {
        return <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 512 512">
    ...
    useEffect(() => {
        // Gather all the data in one place for faster and easier access.
    ...
    useEffect(() => {
        ...
        // CLose the filterBox whenever the user click anywhere within the body.
        const closeFilterBox = () => filterBoxOpen && document.activeElement !== filterBtn.current && setFilterBoxOpen(false);

        document.body.addEventListener('click', closeFilterBox);

        return () => document.body.removeEventListener('click', closeFilterBox);
    }, [filterBoxOpen])
    ...
    return (
        <main id='container'>
            ...
            <header id="searchPage_head">

                <span id="sphLeft"></span>

                <div id="sphMiddle">
                    <span id="sphSearchCont">
                        ...
                        <button className={searchVal.trim() ? '' : 'disable'} onClick={() => setSearchVal('')}>
                ...
                <span id="sphRight">
                    ...
                    <button ref={filterBtn} className={`btns ${filterBoxOpen ? 'active' : ''}`} onClick={() => filterBoxOpen ? setFilterBoxOpen(false) : setFilterBoxOpen(true)}>
                    ...
                    <CSSTransition in={filterBoxOpen} timeout={500} classNames="slideDown" unmountOnExit>
                        <div id="spOptionBox">
                            <button className="spOptionBtns" onClick={() => setFilter('all')}>
                                {filter === 'all' ?
                            ...
                            <button className="spOptionBtns" onClick={() => setFilter('like')}>
                                {filter === 'like' ?
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 512 512"><path d="M256 32a224 224 0 1 1 0 448 224 224 0 1 1 0-448zm0 480A256 256 0 1 0 256 0a256 256 0 1 0 0 512z"></path><path d="M256 160a96 96 0 1 0 0 192 96 96 0 1 0 0-192z"></path></svg>
                                    :
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 512 512"><path d="M256 32a224 224 0 1 1 0 448 224 224 0 1 1 0-448zm0 480A256 256 0 1 0 256 0a256 256 0 1 0 0 512z"></path></svg>
                            ...
                            <button className="spOptionBtns" onClick={() => setFilter('offline')}>
                                {filter === 'offline' ?
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 512 512"><path d="M256 32a224 224 0 1 1 0 448 224 224 0 1 1 0-448zm0 480A256 256 0 1 0 256 0a256 256 0 1 0 0 512z"></path><path d="M256 160a96 96 0 1 0 0 192 96 96 0 1 0 0-192z"></path></svg>
                                    :
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 512 512"><path d="M256 32a224 224 0 1 1 0 448 224 224 0 1 1 0-448zm0 480A256 256 0 1 0 256 0a256 256 0 1 0 0 512z"></path></svg>
                            ...
                            <button className="spOptionBtns" onClick={() => setFilter('archive')}>
                                {filter === 'archive' ?
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 512 512"><path d="M256 32a224 224 0 1 1 0 448 224 224 0 1 1 0-448zm0 480A256 256 0 1 0 256 0a256 256 0 1 0 0 512z"></path><path d="M256 160a96 96 0 1 0 0 192 96 96 0 1 0 0-192z"></path></svg>
                                    :
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 512 512"><path d="M256 32a224 224 0 1 1 0 448 224 224 0 1 1 0-448zm0 480A256 256 0 1 0 256 0a256 256 0 1 0 0 512z"></path></svg>
                            ...
                            <button className="spOptionBtns" onClick={() => setFilter('folder')}>
                                {filter === 'folder' ?
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 512 512"><path d="M256 32a224 224 0 1 1 0 448 224 224 0 1 1 0-448zm0 480A256 256 0 1 0 256 0a256 256 0 1 0 0 512z"></path><path d="M256 160a96 96 0 1 0 0 192 96 96 0 1 0 0-192z"></path></svg>
                                    :
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 512 512"><path d="M256 32a224 224 0 1 1 0 448 224 224 0 1 1 0-448zm0 480A256 256 0 1 0 256 0a256 256 0 1 0 0 512z"></path></svg>
                ...
                <SwitchTransition>
                    <CSSTransition key={searchVal.trim() + filter} timeout={100} classNames="fade">
                        {searchVal.trim() === '' ?
                                    ...
                                    <>
                                        ...
                                        <div id="suggestionBody">
                                            {(filter === 'all' && filteredData.length === 0 ? searchData : filteredData)?.sort((a, b) => a.name.localeCompare(b.name)).map((el, index) => (
                                                <span key={index} className="searchSuggestionTile" onClick={() => setSearchVal(el.name)}>
                                                    {
                                                        el.type === 'note' ? <NoteIcon />
                                                            : el.type === 'task' ? <TaskIcon />
                                                                : el.type === 'canvas' ? <CanvasIcon />
                                                                    : el.type === 'folder' && <FolderIcon />
                                                    }
                                                    {el.name}
                                                </span>
                                            ))}
                            ...
                            :
                            filteredData.length ?
                                <section id='searchResultCont'>

                                    <div id="searchResultHead">
                                        <label>Results:</label>
                                    </div>

                                    <ul id="searchResultBody">
