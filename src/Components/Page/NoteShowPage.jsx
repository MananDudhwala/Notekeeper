...
export default function NoteShowPage(props) {
    ...
    useEffect(() => {
        ...
        const fetchSpeechVoice = localStorage.getItem('SpeechVoice') || null;
    ...
    const speechVoiceChange = (e) => {
        ...
        localStorage.setItem('SpeechVoice', e.target.value);
    }
    ...
    return (
        <>
            ...
            <main id="notePage" className={`${isBackground ? 'bgImgBackdropFilter' : ''}`} style={isBackground ? { backgroundImage: `url(${backgroundImg})` } : null}>

                <CSSTransition in={speechSettingBox} timeout={500} classNames="slideDown" unmountOnExit>
                    <section id="npListenSettingCont">
                        <div id="npListenSettingBox">
                            <button id="npListenboxCloseBtn" onClick={handleSpeechSettingBox}>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
                                    <path d="M2.146 2.854a.5.5 0 1 1 .708-.708L8 7.293l5.146-5.147a.5.5 0 0 1 .708.708L8.707 8l5.147 5.146a.5.5 0 0 1-.708.708L8 8.707l-5.146 5.147a.5.5 0 0 1-.708-.708L7.293 8 2.146 2.854Z" />
                                </svg>
                            </button>
                            <div id="npListenSettingVoiceBox">
                                <label>Voices</label>
                                <select id="npVoiceDropDown" value={speechVoice} onChange={speechVoiceChange}>
                ...
                <header id="npHead">
                    ...
                    <div id="nphLeft">
                        <button id="npExitBtn" className="btns" onClick={() => navigate(window.history.length > 1 ? -1 : '/home')}>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
                    ...
                    <div id="nphMiddle">
                        <div id="nphNoteName">{noteToShow?.name}</div>
                    </div>

                    <div id="nphRight">
                        <button id="npMoreBtn" ref={optionBoxBtn} className={`btns ${moreBoxOpen ? 'active' : ''}`} onClick={() => setMoreBoxOpen(!moreBoxOpen)}>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
                        ...
                        <CSSTransition in={moreBoxOpen} timeout={500} classNames="slideDown" unmountOnExit>
                            <div id="spOptionBox">
                                {isOwner &&
                                    <>
                                        <button className="spOptionBtns" onClick={() => props.updateNotesData('like', noteToShow)}>
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
                                        ...
                                        <button className="spOptionBtns" onClick={() => props.updateNotesData('pin', noteToShow)}>
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
                                        ...
                                        <button className="spOptionBtns" onClick={() => props.updateNotesData('archive', noteToShow)}>
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
                                        ...
                                        {props.user?.authProvider !== "guest" && window.navigator.onLine &&
                                            <button className="spOptionBtns" onClick={() => props.updateNotesData('download', noteToShow)}>
                                        ...
                                        <button className="spOptionBtns" onClick={() => props.updateWarning({ show: true, msg: `Are you sure you want to delete '${noteToShow.name}'?`, greenMsg: 'Cancel', redMsg: 'Delete', func: () => props.updateNotesData('delete', noteToShow, () => navigate('/home')) })}>
                                        ...
                                        {props.user?.authProvider !== "guest" &&
                                            <button className="spOptionBtns" onClick={copyLinkToClipboard}>
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 512 512">
                                        ...
                                        <button className="spOptionBtns" onClick={handleManageFolder}>
                                ...
                                <button className="spOptionBtns" onClick={convertToPDF}>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
                                ...
                                <button className="spOptionBtns" onClick={convertToHTML}>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
                ...
                <section id="npBody" ref={noteBody}></section>

                <footer id="npFoot">

                    <div id="npfLeft">

                        <span id="npLettersCount">Letters :
                            <span className="numberFont">{noteToShow?.content.trim().length}</span>
                        </span>

                        <span id="npWordsCount">Words :
                            <span className="numberFont">{noteToShow?.content.trim().length ? noteToShow?.content.trim().split(/\s+/).length : 0}</span>
                        </span>
                    </div>

                    <div id="npfMiddle">
                        <div id="npfCreationDate">Created at :
                            <span className="numberFont">{new Date(noteToShow?.date).toLocaleDateString()}</span>
                        </div>
                    </div>
                    ...
                    <div id="npfRight">
                        ...
                        <div id="nphListenBox">
                            ...
                            <button id="npListenBtn" className={`${noteListenState !== 'stop' ? 'active' : ''} btns tooltip tooltipTop`} data-tooltipcontent={noteListenState === 'stop' ? "Speak" : "Speaking"} onClick={toggleListenState}>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
                            ...
                            <div id="nphListenOptions" className={noteListenState !== 'stop' ? 'nphListenOptions_open' : ''}>

                                <button className="nphListenOptionBtn" onClick={handlePlayPauseChange}>
                                ...
                                <button id="npSettingBtn" className="nphListenOptionBtn" onClick={handleSpeechSettingBox}>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
                        ...
                        <button className="btns tooltip tooltipTop" data-tooltipcontent="Copy Content" onClick={copyContentToClipboard}>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
                        ...
                        {isOwner &&
                            <Link to="edit">
                                <button id="npEditBtn" className="btns">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
