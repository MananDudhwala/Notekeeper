                            ...
                            if (user?.authProvider === 'email') {
                                ...
                                emailjs.send(import.meta.env.VITE_EMAILJS_SERVICE_ID, import.meta.env.VITE_EMAILJS_TEMPLATE_ID, {
                                    ...
                                    .then(() => {
                                        ...
                                        navigate('/login');
                                        localStorage.setItem('PasswordResetData', JSON.stringify({ date: new Date().toLocaleDateString(), email: window.btoa(emailVal), key: window.btoa(newKey) }))
