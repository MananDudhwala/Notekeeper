...
export default function CreatePage() {
    ...
    return (
        <div id="createPage">
            ...
            <div id="createPage_body">

                <div className="createPage_optionBox" onClick={() => navigate('/create/note')}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
                ...
                <div className="createPage_optionBox" onClick={() => navigate('/create/task')}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
                ...
                <div className="createPage_optionBox" onClick={() => navigate('/create/canvas')}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
