        ...
        <div id="homePage">
            ...
            <div id="homePageCont">
                <nav>
                    <img src={appLogo} alt="" />
                    <div>
                        <button id="primary" className='homepageBtns' onClick={() => navigate('/signup')}>Sign Up</button>
                        <button id="secondary" className='homepageBtns' onClick={() => navigate('/login')}>Log In</button>
                    </div>
                </nav>

                <header>
                    <div id="homepageHeaderText">
                        <h1>STEP INTO THE FUTURE WITH Notekeeper</h1>
                        ...
                        <div>
                            ...
                            <button className='homepageBtns' onClick={() => navigate('/signup')}>Try as a Guest</button>

                            <button className='homepageBtns' id={"secondary"} onClick={() => navigate('/login')}>Get Started Now</button>
                        </div>
                    </div>
                    <div id="homePageSwipeDown">
                ...
                {appFeatures.map((el, ind) => (
                    <section key={ind}>
                        <div className="homepageSectionText">
                            <h2>{el.title}</h2>
                            <p>{el.description}</p>
                            <button id="primary" className='homepageBtns' onClick={() => navigate('/login')} >Get Started</button>
                        </div>
                    </section>
                ))}

                <section id="homepageFAQSection">
                    <div id="homepageFAQHead">
                        <h2>Frequently Asked Questions</h2>
                    </div>
                    <div id="homepageFAQBody">
                        <div id="homepageFAQBodyLeft">
                            <div>
                ...
                <footer>
                    <div id="top">
                        <h2>Grab Notekeeper Now and Make it your Personal Digital Space</h2>
                        <div>
                            <button className="homepageBtns" onClick={() => navigate('/signup')}>Try as a guest</button>
                            <button id="primary" className="homepageBtns" onClick={() => navigate('/login')}>Get Started Now</button>
                        </div>
                        <p>Don't miss this opportuinity, Notekeeper is free for now. 🤫</p>
                    </div>
                    <div id="bottom" className={''}>
                        <div id="left">
                            <img src={appLogo} alt="" />
                            <p>Made with all the love of our heart.</p>
                            <p>© All Rights Reserved | MD</p>
                        </div>
                        <div id="middle">

                            <label htmlFor="social">Connect with me at:</label>
