...
export default function SettingAccountSection(props) {
    ...
    const signOut = () => {
        ...
        localStorage.removeItem("Notekeeper-ActiveUser");
    ...
    const sendVerificationEmail = () => {
        ...
        const accountVerifyLinkData = JSON.parse(localStorage.getItem('Notekeeper-AccountVerifyLinkData'));
        ...
        if (accountVerifyLinkData && accountVerifyLinkData.date === new Date().toLocaleDateString() && window.atob(accountVerifyLinkData.email) === props.user.email) {
            ...
            emailjs.send(import.meta.env.VITE_EMAILJS_SERVICE_ID, import.meta.env.VITE_EMAILJS_TEMPLATE_ID2, {
                ...
                NotekeeperLink: window.location.origin,
                ...
                .then(() => {
                    ...
                    localStorage.setItem('Notekeeper-AccountVerifyLinkData', JSON.stringify({ date: new Date().toLocaleDateString(), email: props.user.email, key: key }))
    ...
    const requestPasswordChange = () => {
        ...
        const passwordResetLinkData = JSON.parse(localStorage.getItem('PasswordResetData'));
        ...
        if (passwordResetLinkData && window.atob(passwordResetLinkData.email) === props.user?.email && passwordResetLinkData.date === new Date().toLocaleDateString()) {
            ...
            emailjs.send(import.meta.env.VITE_EMAILJS_SERVICE_ID, import.meta.env.VITE_EMAILJS_TEMPLATE_ID, {
                ...
                .then(() => {
                    ...
                    localStorage.setItem('PasswordResetData', JSON.stringify({ date: new Date().toLocaleDateString(), email: window.btoa(props.user?.email), key: window.btoa(key) }))
    ...
    return (
        <div id="settingAccountSection">

            <section id="settingUserCard">

                <div id="settingUserCardTop">
                    <div id="settingUserCardAvatar">
                        {props.user.avatar ?
                            <div id="settingUserAvatarPic" style={{ backgroundImage: `url(${props.user.avatar})` }}></div>
                            :
            ...
            </section>
            {
                ...
                <section className="settingUserWarning redMessage">
            ...
            {
                props.user?.authProvider === "email" && props.user?.isVerified &&
                <section className="settingUserWarning greenMessage">
...

            {
                ...
                <>
                    ...
                    <section className="settingUserWarning yellowMessage">
