...
export default function SettingReportSection(props) {
    ...
    return (
        <div id="settingReportSection">

            {loading && <Loading use={loading} />}

            <div id="settingReportCont">
                <div id="reportContTop">
...
2. For how long you are facing this issue." onChange={e => setReportMsg(e.target.value)}>
                ...
                <div id="reportContBottom">
                    {reportMsg.trim().length > 10 ?
                        <button className="bigBtns" onClick={saveReport}>Submit</button>
                        :
