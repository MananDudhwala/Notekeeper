...
export default function SettingFeedbackSection(props) {
    ...
    return (
        <div id="settingFeedbackSection">
            ...
            <div id="settingFeedbackCont">

                <div id="feedbackCardRating">
...
4. What else should we do for your 5 Stars." onChange={e => setMsgInput(e.target.value)}></textarea>
                ...
                <div id="feedbackCardFoot">
                    {rating > 0 ?
                        <button className="bigBtns" onClick={saveFeedBack}>Submit</button>
                        :
                        <button className="bigBtns disable">Submit</button>
                    }
                </div>
            </div>
        </div>
